...
- `src/plugins/` — feature plugins:
  ...
  - `sectorMap.ts` — campaign map screen: renders the static node graph as a DOM/SVG overlay with status-colored nodes, keyboard/gamepad navigation, and Wave Survival deployment from reachable mission nodes.
