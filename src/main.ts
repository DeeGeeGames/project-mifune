...
game.addResource('hudRefs', {
	...
	sectorMapEl: requireEl('hud-sector-map'),
	sectorMapTitleEl: requireEl('hud-sector-map-title'),
	sectorMapBodyEl: requireEl('hud-sector-map-body'),
	sectorMapRouteEl: requireEl('hud-sector-map-route'),
